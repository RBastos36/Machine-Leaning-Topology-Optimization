...
def topopt(nelx, nely, volfrac, penal, rmin, ft):
    ...
    initialize_dataset('mbb-beam_dataset.h5')

    # Open the HDF5 file at the start and keep it open
    h5file = h5py.File('mbb-beam_dataset.h5', 'a')

    try:
        problem_id = generate_problem_id(nelx, nely, volfrac, rmin)
...
def generate_problem_id(nelx, nely, volfrac, rmin):
...
if __name__ == "__main__":
    ...
    xPhys, obj = topopt(nelx, nely, volfrac, penal, rmin, ft)
